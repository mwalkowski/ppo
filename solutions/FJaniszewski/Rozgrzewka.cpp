...
struct BazaStudentow{int liczba; std::string imie[100]; std::string nazwisko[100]; std::string plec[100]; std::string nr_pesel[100]; std::string numer_indeksu[100];}Baza;
